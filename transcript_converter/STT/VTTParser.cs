...
namespace transcript_converter.stt
{
    /// <summary>
    ...
    /// </summary>
    /// <see cref="https://github.com/AlexPoint/SubtitlesParser/blob/master/SubtitlesParser/Classes/Parsers/VttParser.cs"/>
    ...
    /// 
    /// </summary>
    /// <see cref="https://github.com/AlexPoint/SubtitlesParser/blob/master/SubtitlesParser/Classes/SubtitleItem.cs"/>
    public class SubtitleItem
    {
        ...
        public SimpleTranscriptItem ToSimpleTranscriptItem()
        {
            var startAt = TimeSpan.FromMilliseconds(StartTime);
            var endAt = TimeSpan.FromMilliseconds(EndTime);
